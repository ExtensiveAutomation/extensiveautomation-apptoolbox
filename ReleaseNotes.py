...
try:
	...
	from PyQt4.QtGui import (QTreeWidgetItem, QFont, QColor, QIcon, QDialog, 
							QVBoxLayout, QLabel, QFrame, QTreeWidget, QAbstractItemView, 
							QPalette, QBrush, QHBoxLayout, QPushButton )
except ImportError:
